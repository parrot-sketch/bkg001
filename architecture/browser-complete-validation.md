# Browser Complete Validation

## Executive Summary

This document reports browser-level validation for the Complete Consultation flow. Automated checks cover TypeScript compilation, test suite results, and import boundaries. Manual browser verification items are listed for QA execution.
...
| Check | Status |
|-------|--------|
| New `completeSession` tests | ✅ 8/8 PASS |
| Existing tests | ✅ 1726/1729 PASS |
...
### 2.1 Complete Consultation Flow

| Scenario | Expected Result | Status |
|----------|----------------|--------|
| Open consultation room as doctor | Page loads with consultation room | ☐ Manual |
| Start consultation | Consultation enters ACTIVE state | ☐ Manual |
| Click "Complete Consultation" | Complete dialog opens | ☐ Manual |
| Confirm completion | Consultation completes, redirects | ☐ Manual |
| Workflow state changes to COMPLETED | Header shows completed state | ☐ Manual |
| Draft is discarded | Auto-save stops | ☐ Manual |

### 2.2 Data Integrity

| Scenario | Expected Result | Status |
|----------|----------------|--------|
| Patient info cleared | Patient sidebar cleared | ☐ Manual |
| Notes cleared | Documentation tab cleared | ☐ Manual |
| Vitals cleared | Vitals display cleared | ☐ Manual |
| Queue state updated | Queue panel refreshed | ☐ Manual |

### 2.3 Routing

| Scenario | Expected Result | Status |
|----------|----------------|--------|
| Redirect after completion | Navigates to `/doctor/consultations` | ☐ Manual |
| Browser Back | Returns to previous page | ☐ Manual |
| Browser Forward | Returns to consultations list | ☐ Manual |
...
| Scenario | Expected Result | Status |
|----------|----------------|--------|
| Complete action completes quickly | < 2s | ☐ Manual |
