...
export function Page1PreOpSection(props: {
  ...
  return (
    <div className="space-y-4">
      <FieldGroup id="nor-patient" title="Patient identification">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          <TextField className="md:col-span-2 xl:col-span-1" label="Doctor" value={data.doctor ?? ''} disabled={disabled} onChange={(v) => set('doctor', v)} />
        </div>
      </FieldGroup>

      <FieldGroup id="nor-arrival" title="Arrival details">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
          <DateField label="Arrival date" value={data.arrivalDate ?? ''} disabled={disabled} onChange={(v) => set('arrivalDate', v)} />
          <TimeField showNow label="Time in" value={data.timeIn ?? ''} disabled={disabled} onChange={(v) => set('timeIn', v)} />
          ...
          <TextField className="md:col-span-2 xl:col-span-2" label="Allergies" value={data.allergies ?? ''} disabled={disabled} onChange={(v) => set('allergies', v)} />
          <TextAreaField className="md:col-span-2 xl:col-span-2" label="Comments" value={data.comments ?? ''} disabled={disabled} onChange={(v) => set('comments', v)} rows={2} />
        </div>
      </FieldGroup>

      <FieldGroup id="nor-preop-checklist" title="Pre-op checklist">
        ...
        <div className="pt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <TimeField showNow label="IV start time" value={data.ivStartTime ?? ''} disabled={disabled} onChange={(v) => set('ivStartTime', v)} />
      ...
      <FieldGroup id="nor-theatre-safety" title="Theatre timing & safety">
        <div className="space-y-2">
        ...
        <div className="pt-4 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <TimeField showNow label="Antibiotic time" value={data.antibioticTime ?? ''} disabled={disabled} onChange={(v) => set('antibioticTime', v)} />
          <div />
          <TimeField showNow label="Time in theatre" value={data.timeInTheatre ?? ''} disabled={disabled} onChange={(v) => set('timeInTheatre', v)} />
          <TimeField showNow label="Time out of theatre" value={data.timeOutOfTheatre ?? ''} disabled={disabled} onChange={(v) => set('timeOutOfTheatre', v)} />
          <TimeField showNow label="Operation start" value={data.operationStart ?? ''} disabled={disabled} onChange={(v) => set('operationStart', v)} />
          <TimeField showNow label="Operation finish" value={data.operationFinish ?? ''} disabled={disabled} onChange={(v) => set('operationFinish', v)} />
        </div>
      ...
      <FieldGroup id="nor-catheter" title="Urinary catheter">
      ...
      <FieldGroup id="nor-position" title="Patient position">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <FieldGroup id="nor-skin-prep" title="Skin prep">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <TextField label="Shaved by" value={data.shavedBy ?? ''} disabled={disabled} onChange={(v) => set('shavedBy', v)} />
          <div />
          <MultiSelectField label="Prep agents" value={skinPrepAgents} disabled={disabled} onChange={(v) => set('skinPrepAgents', v)} options={SKIN_PREP_AGENT_OPTIONS} columns={4} />
      ...
      <FieldGroup id="nor-esu" title="Electrosurgical unit" defaultCollapsed>
      ...
      <FieldGroup id="nor-tourniquet" title="Tourniquet" defaultCollapsed>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <TimeField showNow label="Time on" value={data.tourniquetTimeOn ?? ''} disabled={disabled} onChange={(v) => set('tourniquetTimeOn', v)} />
          <TimeField showNow label="Time off" value={data.tourniquetTimeOff ?? ''} disabled={disabled} onChange={(v) => set('tourniquetTimeOff', v)} />
      ...
      <FieldGroup id="nor-drains" title="Drains & wound irrigation" defaultCollapsed>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <MultiSelectField label="Drain types" value={drainTypes} disabled={disabled} onChange={(v) => set('drainTypes', v)} options={DRAIN_TYPE_OPTIONS} columns={3} />
          <MultiSelectField label="Wound irrigation" value={woundIrrigation} disabled={disabled} onChange={(v) => set('woundIrrigation', v)} options={WOUND_IRRIGATION_OPTIONS} columns={3} />
      ...
      <FieldGroup id="nor-wound-pack" title="Wound pack & class">
      ...
      <FieldGroup id="nor-team" title="Surgical team & anaesthesia">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        <div className="pt-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          <TextField className="md:col-span-1 xl:col-span-2" label="Anaesthesia detail" value={data.anaesthesiaDetail ?? ''} disabled={disabled} onChange={(v) => set('anaesthesiaDetail', v)} />
        </div>
      </FieldGroup>

      <FieldGroup id="nor-diagnosis" title="Diagnosis & operation">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
