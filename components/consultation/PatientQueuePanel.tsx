...
export function PatientQueuePanel() {
  ...
  const handleLoadPatient = async (targetAppointmentId: number) => {
    ...
    try {
      ...
      router.push(`/doctor/consultations/session/${targetAppointmentId}`);
    } catch (err: any) {
          ...
          <div className="p-2 space-y-2">
            {sortedQueue.map((queueItem) => {
              ...
              const patientName = queueItem.patient
                ...
                : 'Unknown Patient';
              const canLoad = queueItem.status === AppointmentStatus.IN_CONSULTATION || canStartConsultation(queueItem.status as AppointmentStatus);
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {canLoad && (
                      <Button
                        size="sm"
                        onClick={() => handleLoadPatient(queueItem.id)}
