...
export function QueuePatientCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'px-4 py-3 mx-0 border-b border-[#e7d6bf] bg-white',
        isNext && 'bg-[#e7d6bf]/20',
      )}
    >
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <div className="text-sm font-medium text-[#2c2e4b] truncate">{patientName}</div>
          <div className="text-xs text-[#2c2e4b]/60 mt-0.5">
        ...
        <Button
          ...
          disabled={isStarting}
          className="h-8 px-3 text-xs rounded-lg border-[#e7d6bf] text-[#2c2e4b] hover:bg-[#e7d6bf]/30 shrink-0 transition-colors"
        >
