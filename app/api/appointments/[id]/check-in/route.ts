/**
 * API Route: POST /api/appointments/:id/check-in
 * 
 * Check-in endpoint for appointments (route alias for /checkin).
 * 
 * This route exists to match the frontend API call pattern.
 * It delegates to the same logic as /checkin.
 */
...
export async function POST(
    ...
    try {
        ...
        console.error('[API] POST /api/appointments/[id]/check-in - Unexpected error:', error);
        return NextResponse.json(
            {
                success: false,
