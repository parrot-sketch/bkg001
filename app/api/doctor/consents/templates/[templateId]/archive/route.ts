/**
 * API Route: POST /api/doctor/consents/templates/[templateId]/archive
 *
...
export async function POST(
    ...
    try {
        ...
        const updated = await service.archiveTemplate(templateId, {
        ...
        console.error('[API] POST /api/doctor/consents/templates/[templateId]/archive - Error:', error);
