/**
 * API Route: GET /api/admin/appointments/post-op
 * 
 * Post-operative Appointments endpoint.
 * 
...
/**
 * GET /api/admin/appointments/post-op
 * 
 * Returns post-operative appointments
 */
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    console.error('[API] /api/admin/appointments/post-op - Error:', error);
    return NextResponse.json(
      {
        success: false,
