...
import { Calendar, ChevronLeft, ChevronRight, CheckCircle2, Users, Clock, Shield, FileText, Info } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 md:mb-8 space-y-1.5 md:space-y-2">
          <h1 className="text-2xl md:text-3xl font-semibold text-slate-900 tracking-tight leading-tight">Request a Consultation</h1>
          <p className="text-sm md:text-base text-gray-600 leading-relaxed">Tell us what you'd like to discuss with our surgical team</p>
        </div>
        ...
        <div className="bg-white border-0 rounded-xl p-5 md:p-6 lg:p-8 mb-6 shadow-sm">
          {/* Step 1: Identity */}
          {currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`h-11 text-base ${hasProfile ? 'bg-gray-50 text-gray-600' : 'bg-white'}`}
                    required
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled
                  className="h-11 text-base bg-gray-50 text-gray-600"
                />
              </div>
                  ...
                  services
                    ...
                    .map((service) => {
                      ...
                      return (
                        <div
                          key={service.id}
                          className={`p-4 md:p-5 rounded-xl border-2 text-left transition-all min-h-[90px] md:min-h-[100px] touch-manipulation ${
                            isSelected
                        ...
                        >
                          <button
                            ...
                            className="w-full text-left touch-manipulation min-h-[60px] py-2"
                          >
                            <div className="font-medium text-sm md:text-base text-slate-900 mb-1.5 flex items-start justify-between gap-2">
                              <span className="leading-tight">{service.service_name}</span>
                              {isSelected && (
                                <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-teal-600 flex-shrink-0 mt-0.5" />
                              )}
                            </div>
                            {service.description && (
                              <div className="text-xs md:text-sm text-gray-600 mt-1.5 line-clamp-2 leading-relaxed">{service.description}</div>
                            )}
                          </button>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-lg md:static md:border-t-0 md:shadow-none md:bg-transparent md:z-auto md:mt-6">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:px-0 md:py-0">
            <div className="flex items-center justify-between gap-3 md:gap-4">
              <Button
                ...
                className="h-11 md:h-10 min-w-[100px] md:min-w-[120px] text-sm md:text-base border-gray-300 text-gray-700 hover:bg-gray-50"
              >
                <ChevronLeft className="h-4 w-4 mr-1.5 md:mr-2" />
                Previous
              </Button>
              ...
              {currentStep < TOTAL_STEPS ? (
                <Button
                  ...
                  className="h-11 md:h-10 min-w-[100px] md:min-w-[120px] text-sm md:text-base bg-teal-600 hover:bg-teal-700 text-white font-medium"
                >
                  Continue
                  <ChevronRight className="h-4 w-4 ml-1.5 md:ml-2" />
                </Button>
              ) : (
                <Button
                  type="button"
                  ...
                  disabled={!canProceed() || isSubmitting}
                  className="h-11 md:h-10 min-w-[140px] md:min-w-[160px] text-sm md:text-base bg-teal-600 hover:bg-teal-700 text-white font-medium"
                >
                  {isSubmitting ? (
                    <>
                    ...
                    <>
                      <CheckCircle2 className="h-4 w-4 mr-1.5 md:mr-2" />
                      Submit Request
                    </>
                  )}
                </Button>
