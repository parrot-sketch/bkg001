...
/**
 * Nurse Theatre Support Queue
 *
 * View and manage surgical cases currently in theater.
...
export default function TheatreSupportPage() {
        ...
        return (
            <div className="flex items-center justify-center h-[60vh]">
                <div className="text-center">
                    <p className="text-muted-foreground">Please log in to view theatre support queue</p>
                    <Link href="/login">
        ...
        <div className="animate-in fade-in duration-500 pb-10">
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-lg font-bold tracking-tight text-slate-900">Theatre Support Queue</h1>
                        <p className="text-sm text-slate-500 mt-1">
                            Active surgical cases currently in operating theaters
                        </p>
                    </div>
                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                    {isLoading ? (
                        ...
                        <div className="p-12 text-center">
                            ...
                            <h3 className="text-slate-900 font-medium">Failed to load theatre queue</h3>
                        ...
                        <div className="text-center py-20 bg-slate-50/50">
                            ...
                            <h3 className="text-slate-900 font-medium mb-1">No active cases</h3>
                            <p className="text-sm text-slate-500">
                                There are currently no patients in the operating theater.
                            </p>
                        </div>
                    ) : (
                        <Table>
