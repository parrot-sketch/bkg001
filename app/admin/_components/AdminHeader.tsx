                ...
                {breadcrumbs.map((crumb, i) => (
                    <div key={crumb.href} className="flex items-center min-w-0">
                        <span className={cn(
                            ...
                            crumb.isLast ? "text-slate-900" : "text-slate-500"
                        )}>
                            {crumb.label}
                        </span>
                        {!crumb.isLast && <ChevronRight className="mx-1 h-4 w-4 text-slate-400" />}
                    </div>
                ))}
            </div>
            ...
            <div className="flex items-center space-x-3">
                ...
                <div className="hidden md:flex items-center relative group">
                    ...
                    <input 
                        ...
                        className="pl-9 pr-4 py-1.5 h-9 w-64 bg-slate-50 border-slate-200 border rounded-full text-xs focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                    />
                </div>
