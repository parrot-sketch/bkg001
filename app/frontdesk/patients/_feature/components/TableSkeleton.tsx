...
/**
 * Renders a shimmer skeleton table matching the real table's column layout.
 * Shown while the initial patient list is loading.
 */
    ...
    <div className="space-y-1">
      {Array.from({ length: 6 }).map((_, i) => (
        <div key={i} className="flex items-center gap-4 px-5 py-3 border-b border-[#e7d6bf]/60">
          ...
          <Skeleton className="h-4 w-24 hidden lg:block bg-[#e7d6bf]/10" />
