...
import { Search, RefreshCw, AlertTriangle, CheckCircle2, Package } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">View and manage inventory items</p>
      </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <div className="relative">
                ...
                <Input placeholder="Search items..." value={searchQuery} onChange={e => { setSearchQuery(e.target.value); setPage(1); }} className="pl-8 w-48" />
              </div>
        ...
        <CardContent>
          {loading && items.length === 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm font-medium text-slate-900">No inventory items found</p>
            </div>
          ) : (
            <Table>
              <TableHeader>
