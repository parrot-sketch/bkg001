...
const VALID_FINAL_DATA: NursePreopWardChecklistData = {
    header: {
        date: '2030-01-01',
        nursingComments: 'Patient stable, ready for theatre.',
    },
    documentation: {
        wardChecklist: true,
    ...
    bloodResults: {
        bloodResultsChecked: true,
        hb: '12.5',
        uecs: 'Normal',
        xMatchUnitsAvailable: 2,
    },
    medications: {
        preMedicationText: 'Midazolam 2mg',
        periOpMedicationText: 'Cefazolin 1g',
        regularMedicationText: 'Amlodipine 5mg',
        preMedGiven: true,
    ...
    vitals: {
        ...
        bladderEmptied: true,
        foetalHeartRate: 140,
        foetalHeartRateNotes: 'Normal baseline',
        height: 170,
        weight: 65,
        urinalysisDone: true,
        otherFormsRequired: '',
