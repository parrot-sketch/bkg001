...
describe('SurgicalCaseService — State Machine', () => {
  ...
  describe('valid transitions', () => {
    const validTransitions: [SurgicalCaseStatus, SurgicalCaseStatus][] = [
      ...
      [SurgicalCaseStatus.READY_FOR_SCHEDULING, SurgicalCaseStatus.READY_FOR_THEATER_PREP],
      ...
      [SurgicalCaseStatus.READY_FOR_THEATER_BOOKING, SurgicalCaseStatus.SCHEDULED],
