...
describe('SurgicalCaseService — State Machine', () => {
  ...
  describe('valid transitions', () => {
    const validTransitions: [SurgicalCaseStatus, SurgicalCaseStatus][] = [
      ...
      [SurgicalCaseStatus.PLANNING, SurgicalCaseStatus.READY_FOR_WARD_PREP],
      [SurgicalCaseStatus.PLANNING, SurgicalCaseStatus.DRAFT],
      [SurgicalCaseStatus.PLANNING, SurgicalCaseStatus.CANCELLED],
      [SurgicalCaseStatus.READY_FOR_WARD_PREP, SurgicalCaseStatus.IN_WARD_PREP],
      [SurgicalCaseStatus.READY_FOR_WARD_PREP, SurgicalCaseStatus.PLANNING],
      [SurgicalCaseStatus.READY_FOR_WARD_PREP, SurgicalCaseStatus.CANCELLED],
      [SurgicalCaseStatus.IN_WARD_PREP, SurgicalCaseStatus.READY_FOR_THEATER_BOOKING],
      [SurgicalCaseStatus.IN_WARD_PREP, SurgicalCaseStatus.READY_FOR_WARD_PREP],
      [SurgicalCaseStatus.IN_WARD_PREP, SurgicalCaseStatus.CANCELLED],
      [SurgicalCaseStatus.READY_FOR_THEATER_BOOKING, SurgicalCaseStatus.READY_FOR_THEATER_PREP],
      [SurgicalCaseStatus.READY_FOR_THEATER_BOOKING, SurgicalCaseStatus.IN_WARD_PREP],
      [SurgicalCaseStatus.READY_FOR_THEATER_BOOKING, SurgicalCaseStatus.CANCELLED],
      [SurgicalCaseStatus.READY_FOR_THEATER_PREP, SurgicalCaseStatus.READY_FOR_THEATER_BOOKING],
      [SurgicalCaseStatus.READY_FOR_THEATER_PREP, SurgicalCaseStatus.CANCELLED],
      [SurgicalCaseStatus.SCHEDULED, SurgicalCaseStatus.IN_PREP],
      [SurgicalCaseStatus.SCHEDULED, SurgicalCaseStatus.READY_FOR_THEATER_BOOKING],
      [SurgicalCaseStatus.SCHEDULED, SurgicalCaseStatus.CANCELLED],
      [SurgicalCaseStatus.IN_PREP, SurgicalCaseStatus.IN_THEATER],
      [SurgicalCaseStatus.IN_PREP, SurgicalCaseStatus.READY_FOR_THEATER_BOOKING],
      [SurgicalCaseStatus.IN_PREP, SurgicalCaseStatus.CANCELLED],
